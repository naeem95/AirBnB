...
export default class Save extends Component {
  ...
  render() {
    return (
      ...
      <TitleBar name = "Saved" sub = "Just do it" />
      <View style={{borderBottomWidth:1, borderColor:"#e3e3e3", paddingBottom:30}}>
      <Text style={{fontSize:24, color:'#222', margin:20, marginLeft:5, fontWeight:'300'}}>Recent </Text>
      {this.renderThis(current)}
      </View>
      <Text style={{fontSize:24, color:'#222', margin:20, marginLeft:5, fontWeight:'300'}}>Your wishlist</Text>
      <ListView
